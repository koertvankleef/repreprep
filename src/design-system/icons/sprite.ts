const ICON_SPRITE_ID = 'rrr-icon-sprite'

const spriteMarkup = `
<svg id="${ICON_SPRITE_ID}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" style="position:absolute;width:0;height:0;overflow:hidden">
  <symbol id="icon-contrast" fill="currentColor" viewBox="0 0 24 24">
    <path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10Zm0-1.5v-17a8.5 8.5 0 0 1 0 17Z" />
  </symbol>
  <symbol id="icon-weather-sunny" fill="currentColor" viewBox="0 0 24 24">
  ...
  <symbol id="icon-weather-moon" fill="currentColor" viewBox="0 0 24 24">
  ...
  <symbol id="icon-chevron-down" fill="currentColor" viewBox="0 0 24 24">
